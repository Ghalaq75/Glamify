...
export default function ProviderEarnings() {
  ...
  return (
    <div>
      ...
      <div style={{ background: 'var(--color-info-bg)', border: '1px solid #aad4ea', borderRadius: 'var(--radius-md)', padding: '0.875rem 1rem', marginBottom: '1.5rem', color: 'var(--color-info)', fontSize: '0.875rem' }}>
