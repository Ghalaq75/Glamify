  ...
  return (
    <AuthLayout>
      <div style={{ width: '100%', maxWidth: '380px' }}>
        ...
        {sent ? (
          <div>
            <div className="alert alert-success" style={{ marginBottom: '1rem', display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }}><Icon name="check" size="1rem" /> Reset link generated.</div>
            {resetLink && (
