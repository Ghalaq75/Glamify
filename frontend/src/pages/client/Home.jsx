...
export default function ClientHome() {
  ...
  const activeFilterCount = (category !== 'All' ? 1 : 0) + (district ? 1 : 0) + (searchDate ? 1 : 0);
  ...
  const visibleProviders = useMemo(() => {
    ...
    if (nearMe && coords) {
      list = list
        .map(p => {
          const d = (typeof p.latitude === 'number' && typeof p.longitude === 'number')
    ...
    <div className="client-home-discover">
      ...
      <section className="home-hero-banner" aria-label="Welcome">
        ...
        <div className="home-hero-banner-copy">
          ...
          <h1>Beauty at your door,<br />in Riyadh.</h1>
        ...
        <svg className="home-hero-banner-ornament" viewBox="0 0 600 12" preserveAspectRatio="none" aria-hidden="true">
          <line x1="0" y1="6" x2="600" y2="6" stroke="var(--color-sand)" strokeWidth="0.5" />
          {[...Array(30)].map((_, i) => (
            <polygon key={i} points={`${i * 20 + 10},2 ${i * 20 + 14},6 ${i * 20 + 10},10 ${i * 20 + 6},6`} fill="var(--color-burgundy)" fillOpacity="0.35" />
          ))}
        </svg>
      </section>
      ...
      <section className="home-brand-intro" aria-label="About Glamify">
        <div className="home-brand-intro-copy">
          ...
          <p className="home-brand-intro-body">
            Glamify connects you with hand-picked beauty professionals — hair, skin, nails, wellness and more — who come to your home, hotel, or office. Every provider is verified and reviewed by real clients.
          </p>
        ...
        <div className="home-brand-intro-photo-wrap">
          ...
          <div className="home-brand-intro-tag">
            <span className="home-kicker" style={{ color: 'var(--color-primary)' }}>Est. Riyadh</span>
            <span style={{ fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic', fontSize: '1.1rem' }}>Glamify</span>
          </div>
        </div>
      </section>
      ...
      <div className="home-stats-row" aria-label="Glamify by the numbers">
        {STATS.map((s, i) => (
          <div key={s.label} className="home-stats-item" style={i < STATS.length - 1 ? { borderRight: '1px solid rgba(170,150,120,0.25)' } : {}}>
      ...
      {/* ── Editorial feature 1: image left, text right ───────────────── */}
      <section className="home-feature" aria-label="Vetted professionals">
        ...
        <div className="home-feature-copy">
          ...
          <h2 className="home-feature-heading">Vetted professionals,<br /><em>at your door.</em></h2>
          <p className="home-feature-body">
            Every Glamify provider goes through a rigorous onboarding process — background checks, portfolio review, and client rating monitoring. You only see the best.
          </p>
      ...
      {/* ── Editorial feature 2: text left, image right ───────────────── */}
      <section className="home-feature home-feature-reverse" aria-label="Book on your schedule">
        <div className="home-feature-copy">
          ...
          <h2 className="home-feature-heading">Your beauty routine,<br /><em>your schedule.</em></h2>
          <p className="home-feature-body">
            Browse by service, district, or availability. Pick a time that works for you — morning, evening, or weekend. No waiting rooms, no commutes.
          </p>
          <ul className="home-feature-list">
      ...
      <section id="discover" aria-label="Find beauty pros">
        ...
        >
          ...
          >
            <Icon name="sliders" size="0.95rem" /> Filters{activeFilterCount > 0 ? ` · ${activeFilterCount}` : ''}
          </button>
        </form>
          ...
          <div className="filters-panel" role="region" aria-label="Filters">
            ...
            <label className="filters-field">
              ...
              >
                ...
                {DISTRICTS.map(d => (
                  <option key={d.id} value={d.id}>{d.englishName}</option>
                ))}
              </select>
            </label>
            <label className="filters-field">
            ...
            {activeFilterCount > 0 && (
              <button
                ...
                onClick={() => { setCategory('All'); setDistrict(''); setSearchDate(''); }}
              >
                Clear filters
              </button>
            )}
      ...
      <h2 className="section-heading" style={{ marginTop: '1.5rem' }}>Beauty pros near you</h2>
                ...
                <div className="provider-row-info">
                  ...
                  <div className="provider-row-meta">
                    ...
                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem' }}>
                      <Icon name="pin" size="0.75rem" />{p.location}
                    ...
                    {p.isAvailableToday && (
                      <>
                        <span className="provider-row-meta-dot" />
                        <span style={{ color: 'var(--color-primary)', fontWeight: 600 }}>Available today</span>
                      </>
                    )}
                  </div>
                </div>
      ...
      <div className="home-newsletter" aria-label="Stay in touch">
        ...
        <h2 className="home-newsletter-heading">New providers. New services.<br />First to know.</h2>
        <p className="home-newsletter-sub">Join our newsletter for curated beauty picks, new arrivals, and exclusive Riyadh offers.</p>
        {subscribed ? (
          <p style={{ fontFamily: 'Cormorant Garamond, serif', fontStyle: 'italic', fontSize: '1.1rem', color: 'rgba(232,226,212,0.9)', marginTop: '0.5rem' }}>
          ...
          <form className="home-newsletter-form" onSubmit={handleSubscribe}>
            <input
              ...
              required
            />
            <button type="submit" className="btn home-newsletter-btn">Subscribe</button>
          </form>
        )}
      </div>
